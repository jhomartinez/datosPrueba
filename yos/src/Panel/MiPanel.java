...
public class MiPanel extends JPanel implements Runnable{
	...
	private ImageIcon inicio3 = new ImageIcon("imagenes/fondo2.gif");
	private ImageIcon inicio4 = new ImageIcon("imagenes/fondo3.gif");
	...
	private ImageIcon fondo1 = new ImageIcon("imagenes/fondo2.gif");
	private ImageIcon fondo2 = new ImageIcon("imagenes/fondo3.gif");
...
/////////////////////////////////////////////////////////////////////////////////	
	public MiPanel(int personaje){
		if(personaje == 1) {
			mario = new Mario("imagenes/mario.gif", 55, 570); 
		} else {
			mario = new Mario("imagenes/yoshy.gif", 55, 570);
		}
		perdidos=0;
		atrapados=0;
		restantes=15;
	...
	public void paint(Graphics g){
		...
		if(nivel == 1) {
			...
			inicio3.paintIcon(b_inicio, g, 0, 0);
			fondo1.paintIcon(b_fondo, g, 0, 0);
		} else {
			inicio4.paintIcon(b_inicio, g, 0, 0);
			fondo2.paintIcon(b_fondo, g, 0, 0);
		}
